    ...
    GM_xmlhttpRequest({
        ...
        onload: function (xhr) {
            ...
            GM_xmlhttpRequest({
                ...
                data: "wiql=SELECT [System.Id], [System.Title], [Microsoft.VSTS.Scheduling.RemainingWork] FROM WorkItems WHERE [System.TeamProject] = @project AND [System.WorkItemType] = 'Task' AND [System.State] <> 'Deleted' AND [System.State] <> 'Removed' AND ([System.IterationPath] UNDER [System.IterationPath] UNDER 'SEGOT-eCom-VolvoPentaShop\\2014 - EPC 2\\EPC - Iteration 5 (W4 - W5)') AND [System.AssignedTo] = @me ORDER BY [System.Title]"
                + "&runQuery=true"
